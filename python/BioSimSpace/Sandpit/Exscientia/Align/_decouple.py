...
def decouple(molecule, property_map0=None, property_map1=None, intramol=True):
    ...
    if molecule._is_perturbable:
        raise _IncompatibleError("'molecule' has already been perturbabled!")
    ...
    mol_edit.setProperty("molecule0", mol_sire)
    mol_edit.setProperty("molecule1", mol_sire)
    ...
    mol_edit.setProperty("intramol", _SireBase.wrap(intramol))
    ...
    # Flag that the molecule is decoupled.
    mol._is_decoupled = True
