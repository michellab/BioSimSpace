...
def matchAtoms(molecule0,
    ...
    """Find mappings between atom indices in molecule0 to those in molecule1.
       ...
       >>> mappings = matchAtoms(molecule0, molecule1, matches=5)

       Find the 5 best mappings along with their ranking scores.

       >>> mappings, scores = matchAtoms(molecule0, molecule1, matches=5, return_scores=True)
       ...
       >>> mapping = matchAtoms(molecule0, molecule1, prematch={AtomIdx(0), AtomIdx(10)})

       Find the best mapping, excluding light atoms.

       >>> mapping = matchAtoms(molecule0, molecule1, match_light=False)
    """
...
def rmsdAlign(molecule0, molecule1, mapping=None, property_map0={}, property_map1={}):
    """Align atoms in molecule0 to those in molecule1 using the mapping
       ...
       >>> molecule0 = rmsdAlign(molecule0, molecule1)
    """
...
def merge(molecule0, molecule1, mapping=None, property_map0={}, property_map1={}):
    """Create a merged molecule from 'molecule0' and 'molecule1' based on the
       ...
       >>> merged = merge(molecule0, molecule1, mapping)
       ...
       >>> molecule0 = merge(molecule0, molecule1)
    """
