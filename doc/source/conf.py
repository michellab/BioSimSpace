...
print(
    "Generating doc for BioSimSpace version {version} installed in {path}".format(
        version=BioSimSpace.__version__, path=BioSimSpace.__path__
    )
)
...
project = "BioSimSpace"
copyright = "2017-2021 Michel Lab"
...
# documentation.
html_theme_options = {"logo_only": False, "style_nav_header_background": "#161e3c"}
...
man_pages = [("index", "BioSimSpace", "BioSimSpace Documentation", ["Michel Lab"], 1)]
